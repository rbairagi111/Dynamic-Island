...
extension Notification.Name {
    ...
    static let previewFTUEGlow = Notification.Name("island.previewFTUEGlow")
    static let replayFTUEIntro = Notification.Name("island.replayFTUEIntro")
    static let ftueSequenceStarted = Notification.Name("island.ftueSequenceStarted")
